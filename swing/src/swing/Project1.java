...
public class Project1 {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 871, 361);
		...
		button_30.setBounds(259, 230, 54, 91);
		...
		button_35.setBounds(10, 281, 114, 40);
		...
		button_37.setBounds(133, 281, 54, 40);
		...
		button_38.setBounds(196, 281, 54, 40);
		...
		textField.setBounds(10, 32, 569, 40);
		...
		comboBox.setBounds(30, 58, 199, 36);
		panel.add(comboBox);
		...
		Double india=30.0,usa=24.0,uk=32.0;
		btnConvert.addActionListener(new ActionListener() {
			...
			{
				String c=String.format("Pound. %.2f", db*uk);
				lblNewLabel.setText(c);
			}
			}
		});
		btnConvert.setBounds(27, 235, 89, 23);
		...
		btnClear.setBounds(147, 235, 89, 23);
		panel.add(btnClear);
